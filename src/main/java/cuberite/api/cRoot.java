...
public class cRoot {
	...
	class ScheduleTask extends ThreeArgFunction {
		/**
		 * Schedules the callback functions to be called after a certain amount of ticks
		 */
		@Override
		public LuaValue call(LuaValue luaRoot, LuaValue ticks, LuaValue callback) {
	...
	private LuaTable registerCallbacks() {
		...
		value.set("ScheduleTask", new ScheduleTask());
