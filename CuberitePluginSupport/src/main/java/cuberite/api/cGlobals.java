...
public class cGlobals {
	...
	static class LOGERROR extends VarArgFunction { // TODO: Complete this class
		...
		*/
		@Override
		public LuaValue call(LuaValue value) {
			System.out.println(TextType.ERROR.create(value));
			return LuaValue.NIL;
	    }
	}
	...
	static class LOGINFO extends VarArgFunction { // TODO: Complete this class
		...
		*/
		@Override
		public LuaValue call(LuaValue value) {
			System.out.println(TextType.INFO.create(value));
			return LuaValue.NIL;
	    }
	}
	...
	static class LOGWARN extends VarArgFunction { // TODO: Complete this class
		...
		*/
		@Override
		public LuaValue call(LuaValue value) {
			System.out.println(TextType.WARNING.create(value));
			return LuaValue.NIL;
	    }
	}
	...
	public static void initialize(Plugin plugin, Globals globals) {
		...
		globals.set("esEnderCrystal", LuaValue.valueOf(1)); //An ender crystal entity explosion. The SourceData param is the ender crystal entity object.
		globals.set("esGhastFireball", LuaValue.valueOf(2)); //A ghast fireball explosion. The SourceData param is the ghast fireball entity object.
		globals.set("esMax", LuaValue.valueOf(9)); //
		globals.set("esMonster", LuaValue.valueOf(3)); //A monster explosion (creeper). The SourceData param is the monster entity object.
		globals.set("esOther", LuaValue.valueOf(4)); //Any other explosion. The SourceData param is unused.
		globals.set("esPlugin", LuaValue.valueOf(5)); //An explosion started by a plugin, without any further information. The SourceData param is unused.
		globals.set("esPrimedTNT", LuaValue.valueOf(6)); //A TNT explosion. The SourceData param is the TNT entity object.
		globals.set("esWitherBirth", LuaValue.valueOf(7)); //An explosion at a wither's birth. The SourceData param is the wither entity object.
		globals.set("esWitherSkull", LuaValue.valueOf(8)); //A wither skull explosion. The SourceData param is the wither skull entity object.
		...
		globals.set("E_META_BIG_FLOWER_TOP", LuaValue.valueOf(10)); //The metadata of a big flower block that indicates it is the top block.
		...
		globals.set("E_META_CONCRETE_BLACK", LuaValue.valueOf(15)); //A flag in the metadata of concete that indicates that the concrete is black.
		globals.set("E_META_CONCRETE_BLUE", LuaValue.valueOf(11)); //A flag in the metadata of concete that indicates that the concrete is blue.
		globals.set("E_META_CONCRETE_BROWN", LuaValue.valueOf(12)); //A flag in the metadata of concete that indicates that the concrete is brown.
		globals.set("E_META_CONCRETE_CYAN", LuaValue.valueOf(9)); //A flag in the metadata of concete that indicates that the concrete is cyan.
		globals.set("E_META_CONCRETE_GRAY", LuaValue.valueOf(7)); //A flag in the metadata of concete that indicates that the concrete is gray.
		globals.set("E_META_CONCRETE_GREEN", LuaValue.valueOf(13)); //A flag in the metadata of concete that indicates that the concrete is green.
		globals.set("E_META_CONCRETE_LIGHTBLUE", LuaValue.valueOf(3)); //A flag in the metadata of concete that indicates that the concrete is light blue.
		globals.set("E_META_CONCRETE_LIGHTGRAY", LuaValue.valueOf(8)); //A flag in the metadata of concete that indicates that the concrete is light gray.
		globals.set("E_META_CONCRETE_LIGHTGREEN", LuaValue.valueOf(5)); //A flag in the metadata of concete that indicates that the concrete is light green.
		globals.set("E_META_CONCRETE_MAGENTA", LuaValue.valueOf(2)); //A flag in the metadata of concete that indicates that the concrete is magenta.
		globals.set("E_META_CONCRETE_ORANGE", LuaValue.valueOf(1)); //A flag in the metadata of concete that indicates that the concrete is orange.
		globals.set("E_META_CONCRETE_PINK", LuaValue.valueOf(6)); //A flag in the metadata of concete that indicates that the concrete is pink.
		globals.set("E_META_CONCRETE_POWDER_BLACK", LuaValue.valueOf(15)); //A flag in the metadata of concete powder that indicates that the concrete powder is black.
		globals.set("E_META_CONCRETE_POWDER_BLUE", LuaValue.valueOf(11)); //A flag in the metadata of concete powder that indicates that the concrete powder is blue.
		globals.set("E_META_CONCRETE_POWDER_BROWN", LuaValue.valueOf(12)); //A flag in the metadata of concete powder that indicates that the concrete powder is brown.
		globals.set("E_META_CONCRETE_POWDER_CYAN", LuaValue.valueOf(9)); //A flag in the metadata of concete powder that indicates that the concrete powder is cyan.
		globals.set("E_META_CONCRETE_POWDER_GRAY", LuaValue.valueOf(7)); //A flag in the metadata of concete powder that indicates that the concrete powder is gray.
		globals.set("E_META_CONCRETE_POWDER_GREEN", LuaValue.valueOf(13)); //A flag in the metadata of concete powder that indicates that the concrete powder is green.
		globals.set("E_META_CONCRETE_POWDER_LIGHTBLUE", LuaValue.valueOf(3)); //A flag in the metadata of concete powder that indicates that the concrete powder is light blue.
		globals.set("E_META_CONCRETE_POWDER_LIGHTGRAY", LuaValue.valueOf(8)); //A flag in the metadata of concete powder that indicates that the concrete powder is light gray.
		globals.set("E_META_CONCRETE_POWDER_LIGHTGREEN", LuaValue.valueOf(5)); //A flag in the metadata of concete powder that indicates that the concrete powder is light green.
		globals.set("E_META_CONCRETE_POWDER_MAGENTA", LuaValue.valueOf(2)); //A flag in the metadata of concete powder that indicates that the concrete powder is magenta.
		globals.set("E_META_CONCRETE_POWDER_ORANGE", LuaValue.valueOf(1)); //A flag in the metadata of concete powder that indicates that the concrete powder is orange.
		globals.set("E_META_CONCRETE_POWDER_PINK", LuaValue.valueOf(6)); //A flag in the metadata of concete powder that indicates that the concrete powder is pink.
		globals.set("E_META_CONCRETE_POWDER_PURPLE", LuaValue.valueOf(10)); //A flag in the metadata of concete powder that indicates that the concrete powder is purple.
		globals.set("E_META_CONCRETE_POWDER_RED", LuaValue.valueOf(14)); //A flag in the metadata of concete powder that indicates that the concrete powder is red.
		globals.set("E_META_CONCRETE_POWDER_WHITE", LuaValue.valueOf(0)); //A flag in the metadata of concete powder that indicates that the concrete powder is white.
		globals.set("E_META_CONCRETE_POWDER_YELLOW", LuaValue.valueOf(4)); //A flag in the metadata of concete powder that indicates that the concrete powder is yellow.
		globals.set("E_META_CONCRETE_PURPLE", LuaValue.valueOf(10)); //A flag in the metadata of concete that indicates that the concrete is purple.
		globals.set("E_META_CONCRETE_RED", LuaValue.valueOf(14)); //A flag in the metadata of concete that indicates that the concrete is red.
		globals.set("E_META_CONCRETE_WHITE", LuaValue.valueOf(0)); //A flag in the metadata of concete that indicates that the concrete is white.
		globals.set("E_META_CONCRETE_YELLOW", LuaValue.valueOf(4)); //A flag in the metadata of concete that indicates that the concrete is yellow.
		...
		globals.set("E_META_DROPSPENSER_ACTIVATED", LuaValue.valueOf(8)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is currently activated. If this flag is set, the block must be unpowered first and powered again to shoot the next item.
		globals.set("E_META_DROPSPENSER_FACING_MASK", LuaValue.valueOf(7)); //A mask that indicates the bits of the metadata that specify the facing of droppers and dispensers.
		globals.set("E_META_DROPSPENSER_FACING_XM", LuaValue.valueOf(4)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the negative X direction.
		globals.set("E_META_DROPSPENSER_FACING_XP", LuaValue.valueOf(5)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the positive X direction.
		globals.set("E_META_DROPSPENSER_FACING_YM", LuaValue.valueOf(0)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the negative Y direction.
		globals.set("E_META_DROPSPENSER_FACING_YP", LuaValue.valueOf(1)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the positive Y direction.
		globals.set("E_META_DROPSPENSER_FACING_ZM", LuaValue.valueOf(2)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the negative Z direction.
		globals.set("E_META_DROPSPENSER_FACING_ZP", LuaValue.valueOf(3)); //A flag in the metadata of droppers and dispensers that indicates that the dropper or dispenser is looking in the positive Z direction.
		...
		globals.set("E_META_END_PORTAL_FRAME_EYE", LuaValue.valueOf(4)); //A flag in the metadata of end portal frames that indicates that the portal frame has an eye in it.
		globals.set("E_META_END_PORTAL_FRAME_NO_EYE", LuaValue.valueOf(0)); //The lack of the flag in the metadata of end portal frames indicating that the portal frame has an eye in it.
		globals.set("E_META_END_PORTAL_FRAME_XM", LuaValue.valueOf(1)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the negative X direction.
		globals.set("E_META_END_PORTAL_FRAME_XM_EYE", LuaValue.valueOf(5)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the negative X direction and has an ender eye in it.
		globals.set("E_META_END_PORTAL_FRAME_XP", LuaValue.valueOf(3)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the positive X direction.
		globals.set("E_META_END_PORTAL_FRAME_XP_EYE", LuaValue.valueOf(7)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the positive X direction and has an ender eye in it.
		globals.set("E_META_END_PORTAL_FRAME_ZM", LuaValue.valueOf(2)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the negative Z direction.
		globals.set("E_META_END_PORTAL_FRAME_ZM_EYE", LuaValue.valueOf(6)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the negative Z direction and has an ender eye in it.
		globals.set("E_META_END_PORTAL_FRAME_ZP", LuaValue.valueOf(0)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the positive Z direction.
		globals.set("E_META_END_PORTAL_FRAME_ZP_EYE", LuaValue.valueOf(4)); //A flag in the metadata of end portal frames that indicates that the portal frame is facing the positive Z direction and has an ender eye in it.
		...
		globals.set("E_META_HEAD_CREEPER", LuaValue.valueOf(4)); //A flag in the metadata of heads that indicates that the head is a creeper head.
		globals.set("E_META_HEAD_DRAGON", LuaValue.valueOf(5)); //A flag in the metadata of heads that indicates that the head is a dragon head.
		globals.set("E_META_HEAD_PLAYER", LuaValue.valueOf(3)); //A flag in the metadata of heads that indicates that the head is a player head.
		globals.set("E_META_HEAD_SKELETON", LuaValue.valueOf(0)); //A flag in the metadata of heads that indicates that the head is a skeleton head.
		globals.set("E_META_HEAD_WITHER", LuaValue.valueOf(1)); //A flag in the metadata of heads that indicates that the head is a wither head.
		globals.set("E_META_HEAD_ZOMBIE", LuaValue.valueOf(2)); //A flag in the metadata of heads that indicates that the head is a zombie head.
		...
		globals.set("E_META_REDSTONE_REPEATER_FACING_MASK", LuaValue.valueOf(3)); //A mask that indicates the bits of the metadata that specify the facing of redstone repeaters.
		globals.set("E_META_REDSTONE_REPEATER_FACING_XM", LuaValue.valueOf(3)); //A flag in the metadata of redstone repeaters that indicates that the repeater is looking in the negative X direction.
		globals.set("E_META_REDSTONE_REPEATER_FACING_XP", LuaValue.valueOf(1)); //A flag in the metadata of redstone repeaters that indicates that the repeater is looking in the positive X direction.
		globals.set("E_META_REDSTONE_REPEATER_FACING_ZM", LuaValue.valueOf(0)); //A flag in the metadata of redstone repeaters that indicates that the repeater is looking in the negative Z direction.
		globals.set("E_META_REDSTONE_REPEATER_FACING_ZP", LuaValue.valueOf(2)); //A flag in the metadata of redstone repeaters that indicates that the repeater is looking in the positive Z direction.
		...
		globals.set("E_META_SILVERFISH_EGG_CHISELED_STONE_BRICK", LuaValue.valueOf(5)); //A flag in the metadata of the silverfish egg that the block is made from chiseled stone bricks
		globals.set("E_META_SILVERFISH_EGG_COBBLESTONE", LuaValue.valueOf(1)); //
		globals.set("E_META_SILVERFISH_EGG_CRACKED_STONE_BRICK", LuaValue.valueOf(4)); //A flag in the metadata of the silverfish egg that the block is made from cracked stone bricks
		globals.set("E_META_SILVERFISH_EGG_MOSSY_STONE_BRICK", LuaValue.valueOf(3)); //A flag in the metadata of the silverfish egg that the block is made from mossy stone bricks
		...
		globals.set("E_META_SPONGE_DRY", LuaValue.valueOf(0)); //A flag in the metadata of sponges that indicates that the sponge is dry.
		globals.set("E_META_SPONGE_WET", LuaValue.valueOf(1)); //A flag in the metadata of sponges that indicates that the sponge is wet.
		...
		globals.set("caLeftClickOutsideHoldNothing", LuaValue.valueOf(18)); //Left click outside inventory holding nothing
		...
		globals.set("caMiddlePaintBegin", LuaValue.valueOf(22)); //Begining of middle click paint drag action, only valid for creative players
		globals.set("caMiddlePaintEnd", LuaValue.valueOf(28)); //End of middle click paint drag action, only valid for creative players
		globals.set("caMiddlePaintProgress", LuaValue.valueOf(25)); //Add slot for middle click paint drag action, only valid for creative players
		...
		globals.set("caRightClickOutsideHoldNothing", LuaValue.valueOf(19)); //Right click outside inventory holding nothing
		...
		globals.set("dtArrow", LuaValue.valueOf(1)); //Damage received by being attacked by a projectile, possibly from a mob
		globals.set("dtArrowAttack", LuaValue.valueOf(1)); //Damage received by being attacked by a projectile, possibly from a mob
		...
		globals.set("dtEnderPearl", LuaValue.valueOf(15)); //Damage received by throwing an ender pearl and being teleported by it
		globals.set("dtEntityAttack", LuaValue.valueOf(0)); //Damage recieved by being attacked by a mob
		globals.set("dtEnvironment", LuaValue.valueOf(18)); //Damage dealt to mobs from environment: enderman in rain, snow golem in desert
		...
		globals.set("dtProjectile", LuaValue.valueOf(1)); //Damage received by being attacked by a projectile, possibly from a mob
		globals.set("dtRangedAttack", LuaValue.valueOf(1)); //Damage received by being attacked by a projectile, possibly from a mob
		...
		globals.set("E_BLOCK_BLUE_GLAZED_TERRACOTTA", LuaValue.valueOf(246)); //The blocktype for blue glazed terracotta
		...
		globals.set("E_BLOCK_BROWN_GLAZED_TERRACOTTA", LuaValue.valueOf(247)); //The blocktype for brown glazed terracotta
		...
		globals.set("E_BLOCK_CYAN_GLAZED_TERRACOTTA", LuaValue.valueOf(244)); //The blocktype for cyan glazed terracotta
		...
		globals.set("E_BLOCK_DOUBLE_RED_SANDSTONE_SLAB", LuaValue.valueOf(181)); //The blocktype for double red sandstone slab
		...
		globals.set("E_BLOCK_GRAY_GLAZED_TERRACOTTA", LuaValue.valueOf(242)); //The blocktype for gray glazed terracotta
		globals.set("E_BLOCK_GRAY_SHULKER_BOX", LuaValue.valueOf(226)); //The blocktype for gray shulker box
		globals.set("E_BLOCK_GREEN_GLAZED_TERRACOTTA", LuaValue.valueOf(248)); //The blocktype for green glazed terracotta
		...
		globals.set("E_BLOCK_HEAVY_WEIGHTED_PRESSURE_PLATE", LuaValue.valueOf(148)); //The blocktype for heavy weighted pressure plate
		...
		globals.set("E_BLOCK_INVERTED_DAYLIGHT_SENSOR", LuaValue.valueOf(178)); //The blocktype for inverted daylight sensor
		...
		globals.set("E_BLOCK_LIGHT_BLUE_GLAZED_TERRACOTTA", LuaValue.valueOf(238)); //The blocktype for light blue glazed terracotta
		globals.set("E_BLOCK_LIGHT_BLUE_SHULKER_BOX", LuaValue.valueOf(222)); //The blocktype for light blue shulker box
		globals.set("E_BLOCK_LIGHT_GRAY_GLAZED_TERRACOTTA", LuaValue.valueOf(243)); //The blocktype for light gray glazed terracotta
		globals.set("E_BLOCK_LIGHT_GRAY_SHULKER_BOX", LuaValue.valueOf(227)); //The blocktype for light gray shulker box
		globals.set("E_BLOCK_LIGHT_WEIGHTED_PRESSURE_PLATE", LuaValue.valueOf(147)); //The blocktype for light weighted pressure plate
		globals.set("E_BLOCK_LILY_PAD", LuaValue.valueOf(111)); //The blocktype for lily pad
		globals.set("E_BLOCK_LIME_GLAZED_TERRACOTTA", LuaValue.valueOf(240)); //The blocktype for lime glazed terracotta
		...
		globals.set("E_BLOCK_MAGENTA_GLAZED_TERRACOTTA", LuaValue.valueOf(237)); //The blocktype for magenta glazed terracotta
		...
		globals.set("E_BLOCK_ORANGE_GLAZED_TERRACOTTA", LuaValue.valueOf(236)); //The blocktype for orange glazed terracota
		...
		globals.set("E_BLOCK_PINK_GLAZED_TERRACOTTA", LuaValue.valueOf(241)); //The blocktype for pink glazed terracotta
		...
		globals.set("E_BLOCK_PURPLE_GLAZED_TERRACOTTA", LuaValue.valueOf(245)); //The blocktype for purple glazed terracotta
		...
		globals.set("E_BLOCK_REPEATING_COMMAND_BLOCK", LuaValue.valueOf(210)); //The blocktype for repeating command block
		...
		globals.set("E_BLOCK_TERRACOTTA", LuaValue.valueOf(159)); //The blocktype for terracotta (synonym for E_BLOCK_STAINED_CLAY)
		...
		globals.set("E_BLOCK_WHITE_GLAZED_TERRACOTTA", LuaValue.valueOf(235)); //The blocktype for white glazed terracotta
		...
		globals.set("E_BLOCK_YELLOW_GLAZED_TERRACOTTA", LuaValue.valueOf(239)); //The blocktype for yellow glazed terracotta
		...
		globals.set("E_ITEM_MAX_CONSECUTIVE_TYPE_ID", LuaValue.valueOf(452)); //The itemtype for max consecutive type id
		...
		globals.set("E_ITEM_MINECART_WITH_COMMAND_BLOCK", LuaValue.valueOf(422)); //The itemtype for minecart with command block
		...
		globals.set("E_ITEM_NUMBER_OF_CONSECUTIVE_TYPES", LuaValue.valueOf(453)); //The itemtype for number of consecutive types
		...
		globals.set("E_ITEM_POTIONS", LuaValue.valueOf(373)); //The itemtype for potion (obsolete, use E_ITEM_POTION instead)
		...
		globals.set("mtError", LuaValue.valueOf(1)); //Something could not be done (i.e. command not executed due to insufficient privilege)
		globals.set("mtFail", LuaValue.valueOf(1)); //Something could not be done (i.e. command not executed due to insufficient privilege)
		globals.set("mtFailure", LuaValue.valueOf(1)); //Something could not be done (i.e. command not executed due to insufficient privilege)
		...
		globals.set("mtMaxPlusOne", LuaValue.valueOf(10)); //The first invalid type, used for checking on LuaAPI boundaries
		...
		globals.set("BLOCK_FACE_BOTTOM", LuaValue.valueOf(0)); //Please use BLOCK_FACE_YM instead. Interacting with the bottom face of the block.
		globals.set("BLOCK_FACE_EAST", LuaValue.valueOf(5)); //Please use BLOCK_FACE_XM instead. Interacting with the eastern face of the block.
		globals.set("BLOCK_FACE_MAX", LuaValue.valueOf(5)); //Used for range checking - highest legal value for an eBlockFace
		globals.set("BLOCK_FACE_MIN", LuaValue.valueOf(-1)); //Used for range checking - lowest legal value for an eBlockFace
		globals.set("BLOCK_FACE_NONE", LuaValue.valueOf(-1)); //Interacting with no block face - swinging the item in the air
		globals.set("BLOCK_FACE_NORTH", LuaValue.valueOf(2)); //Please use BLOCK_FACE_ZM instead. Interacting with the northern face of the block.
		globals.set("BLOCK_FACE_SOUTH", LuaValue.valueOf(3)); //Please use BLOCK_FACE_ZP instead. Interacting with the southern face of the block.
		globals.set("BLOCK_FACE_TOP", LuaValue.valueOf(1)); //Please use BLOCK_FACE_YP instead. Interacting with the top face of the block.
		globals.set("BLOCK_FACE_WEST", LuaValue.valueOf(4)); //Please use BLOCK_FACE_XP instead. Interacting with the western face of the block.
		...
		globals.set("DIG_STATUS_CANCELLED", LuaValue.valueOf(1)); //The player has let go of the mine block key before finishing mining the block
		globals.set("DIG_STATUS_DROP_HELD", LuaValue.valueOf(4)); //The player has dropped a single item using the Drop Item key (default: Q)
		globals.set("DIG_STATUS_DROP_STACK", LuaValue.valueOf(3)); //The player has dropped a full stack of items using the Drop Item key (default: Q) while holding down a specific modifier key (in windows, control)
		globals.set("DIG_STATUS_FINISHED", LuaValue.valueOf(2)); //The player thinks that it has finished mining a block
		globals.set("DIG_STATUS_SHOOT_EAT", LuaValue.valueOf(5)); //The player has finished shooting a bow or finished eating
		globals.set("DIG_STATUS_STARTED", LuaValue.valueOf(0)); //The player has started digging
		globals.set("DIG_STATUS_SWAP_ITEM_IN_HAND", LuaValue.valueOf(6)); //The player has swapped their held item with the item in their offhand slot (1.9)
		...
		globals.set("mtInvalidType", LuaValue.valueOf(-1)); //Invalid monster type. Returned when monster type not recognized
