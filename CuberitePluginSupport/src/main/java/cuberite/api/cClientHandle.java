...
public class cClientHandle {
    ...
    class GetClientBrand extends OneArgFunction {
         ...
         * 
         * 	string
         * 	Returns the brand that the client has sent in their MC
    ...
    class SendTimeUpdate extends OneArgFunction {
         ...
         * 		Sends the specified time update to the client. WorldAge is the total age of the world, in ticks. TimeOfDay is the current day's time, in ticks (0 - 24000). DoDaylightCycle is a bool that specifies whether the client should automatically move the sun (true) or keep it in the same place (false).
         */
        public LuaValue call(LuaValue handle) {
    ...
    class SetClientBrand extends OneArgFunction {
         ...
         * 
         * ClientBrand	string
         * 		Sets the value of the client's brand. Normally this value is received from the client by a MC
         * Brand plugin message, this function lets plugins overwrite the value.
         */
        public LuaValue call(LuaValue handle) {
