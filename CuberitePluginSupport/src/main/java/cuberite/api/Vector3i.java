...
public class Vector3i {
	...
	static class add extends TwoArgFunction {
		public LuaValue call(LuaValue vector, LuaValue value) {
			if (value.isnumber()) {
				return from(
				vector.get("x").add(value.toint()),
				vector.get("y").add(value.toint()),
				vector.get("z").add(value.toint())
				);
			} else {
				return from(
				vector.get("x").add(value.get("x").toint()),
				vector.get("y").add(value.get("y").toint()),
				vector.get("z").add(value.get("z").toint())
				);
			}
		}
	}
	...
	static class subtract extends TwoArgFunction {
		public LuaValue call(LuaValue vector, LuaValue value) {
			if (value.isnumber()) {
				return from(
				vector.get("x").sub(value.toint()),
				vector.get("y").sub(value.toint()),
				vector.get("z").sub(value.toint())
				);
			} else {
				return from(
				vector.get("x").sub(value.get("x").toint()),
				vector.get("y").sub(value.get("y").toint()),
				vector.get("z").sub(value.get("z").toint())
				);
			}
		}
	}
	...
	static class divide extends TwoArgFunction {
		public LuaValue call(LuaValue vector, LuaValue value) {
			if (value.isnumber()) {
				return from(
				vector.get("x").div(value.toint()),
				vector.get("y").div(value.toint()),
				vector.get("z").div(value.toint())
				);
			} else {
				return from(
				vector.get("x").div(value.get("x").toint()),
				vector.get("y").div(value.get("y").toint()),
				vector.get("z").div(value.get("z").toint())
				);
			}
		}
	}
	...
	static class Cross extends TwoArgFunction {
		...
		*/
		public LuaValue call(LuaValue vector, LuaValue value) {
			...
			return Vector3i.from(b * f - c * e, c * d - a * f, a * e - b * d);
		}
	}
