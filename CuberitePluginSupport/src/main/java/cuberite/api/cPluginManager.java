...
public class cPluginManager {
	...
	public static void addHook(int hook, LuaValue function) {
		...
		switch (hook) {
			case 0:  HookManager.addHook(hHOOK_BLOCK_SPREAD.INSTANCE, 					function); break;
			case 1:  HookManager.addHook(hHOOK_BLOCK_TO_PICKUPS.INSTANCE, 				function); break;
			case 2:  HookManager.addHook(hHOOK_BREWING_COMPLETED.INSTANCE, 				function); break;
			case 3:  HookManager.addHook(hHOOK_BREWING_COMPLETING.INSTANCE, 			function); break;
			case 4:  HookManager.addHook(hHOOK_CHAT.INSTANCE, 							function); break;
			case 5:  HookManager.addHook(hHOOK_CHUNK_AVAILABLE.INSTANCE, 				function); break;
			case 6:  HookManager.addHook(hHOOK_CHUNK_GENERATED.INSTANCE, 				function); break;
			case 7:  HookManager.addHook(hHOOK_CHUNK_GENERATING.INSTANCE, 				function); break;
			case 8:  HookManager.addHook(hHOOK_CHUNK_UNLOADED.INSTANCE, 				function); break;
			case 9:  HookManager.addHook(hHOOK_CHUNK_UNLOADING.INSTANCE, 				function); break;
			case 10: HookManager.addHook(hHOOK_COLLECTING_PICKUP.INSTANCE, 				function); break;
			case 11: HookManager.addHook(hHOOK_CRAFTING_NO_RECIPE.INSTANCE, 			function); break;
			case 12: HookManager.addHook(hHOOK_DISCONNECT.INSTANCE, 					function); break;
			case 13: HookManager.addHook(hHOOK_DROPSPENSE.INSTANCE, 					function); break;
			case 14: HookManager.addHook(hHOOK_ENTITY_ADD_EFFECT.INSTANCE, 				function); break;
			case 15: HookManager.addHook(hHOOK_ENTITY_CHANGED_WORLD.INSTANCE, 			function); break;
			case 16: HookManager.addHook(hHOOK_ENTITY_CHANGING_WORLD.INSTANCE, 			function); break;
			case 17: HookManager.addHook(hHOOK_ENTITY_TELEPORT.INSTANCE, 				function); break;
			case 18: HookManager.addHook(hHOOK_EXECUTE_COMMAND.INSTANCE, 				function); break;
			case 19: HookManager.addHook(hHOOK_EXPLODED.INSTANCE, 						function); break;
			case 20: HookManager.addHook(hHOOK_EXPLODING.INSTANCE, 						function); break;
			case 21: HookManager.addHook(hHOOK_HANDSHAKE.INSTANCE, 						function); break;
			case 22: HookManager.addHook(hHOOK_HOPPER_PULLING_ITEM.INSTANCE, 			function); break;
			case 23: HookManager.addHook(hHOOK_HOPPER_PUSHING_ITEM.INSTANCE, 			function); break;
			case 24: HookManager.addHook(hHOOK_KILLED.INSTANCE, 						function); break;
			case 25: HookManager.addHook(hHOOK_KILLING.INSTANCE, 						function); break;
			case 26: HookManager.addHook(hHOOK_LOGIN.INSTANCE, 							function); break;
			case 27: HookManager.addHook(hHOOK_LOGIN_FORGE.INSTANCE, 					function); break;
			case 28: HookManager.addHook(hHOOK_PLAYER_ANIMATION.INSTANCE, 				function); break;
			case 29: HookManager.addHook(hHOOK_PLAYER_BREAKING_BLOCK.INSTANCE, 			function); break;
			case 30: HookManager.addHook(hHOOK_PLAYER_BROKEN_BLOCK.INSTANCE, 			function); break;
			case 31: HookManager.addHook(hHOOK_PLAYER_CROUCHED.INSTANCE, 				function); break;
			case 32: HookManager.addHook(hHOOK_PLAYER_DESTROYED.INSTANCE, 				function); break;
			case 33: HookManager.addHook(hHOOK_PLAYER_EATING.INSTANCE, 					function); break;
			case 34: HookManager.addHook(hHOOK_PLAYER_FISHED.INSTANCE, 					function); break;
			case 35: HookManager.addHook(hHOOK_PLAYER_FISHING.INSTANCE, 				function); break;
			case 36: HookManager.addHook(hHOOK_PLAYER_FOOD_LEVEL_CHANGE.INSTANCE, 		function); break;
			case 37: HookManager.addHook(hHOOK_PLAYER_JOINED.INSTANCE, 					function); break;
			case 38: HookManager.addHook(hHOOK_PLAYER_LEFT_CLICK.INSTANCE, 				function); break;
			case 39: HookManager.addHook(hHOOK_PLAYER_MOVING.INSTANCE, 					function); break;
			case 40: HookManager.addHook(hHOOK_PLAYER_OPENING_WINDOW.INSTANCE, 			function); break;
			case 41: HookManager.addHook(hHOOK_PLAYER_PLACED_BLOCK.INSTANCE, 			function); break;
			case 42: HookManager.addHook(hHOOK_PLAYER_PLACING_BLOCK.INSTANCE, 			function); break;
			case 43: HookManager.addHook(hHOOK_PLAYER_RIGHT_CLICK.INSTANCE, 			function); break;
			case 44: HookManager.addHook(hHOOK_PLAYER_RIGHT_CLICKING_ENTITY.INSTANCE, 	function); break;
			case 45: HookManager.addHook(hHOOK_PLAYER_SHOOTING.INSTANCE, 				function); break;
			case 46: HookManager.addHook(hHOOK_PLAYER_SPAWNED.INSTANCE, 				function); break;
			case 47: HookManager.addHook(hHOOK_PLAYER_TOSSING_ITEM.INSTANCE, 			function); break;
			case 48: HookManager.addHook(hHOOK_PLAYER_USED_BLOCK.INSTANCE, 				function); break;
			case 49: HookManager.addHook(hHOOK_PLAYER_USED_ITEM.INSTANCE, 				function); break;
			case 50: HookManager.addHook(hHOOK_PLAYER_USING_BLOCK.INSTANCE, 			function); break;
			case 51: HookManager.addHook(hHOOK_PLAYER_USING_ITEM.INSTANCE, 				function); break;
			case 52: HookManager.addHook(hHOOK_PLUGINS_LOADED.INSTANCE, 				function); break;
			case 53: HookManager.addHook(hHOOK_PLUGIN_MESSAGE.INSTANCE, 				function); break;
			case 54: HookManager.addHook(hHOOK_POST_CRAFTING.INSTANCE, 					function); break;
			case 55: HookManager.addHook(hHOOK_PRE_CRAFTING.INSTANCE, 					function); break;
			case 56: HookManager.addHook(hHOOK_PROJECTILE_HIT_BLOCK.INSTANCE, 			function); break;
			case 57: HookManager.addHook(hHOOK_PROJECTILE_HIT_ENTITY.INSTANCE, 			function); break;
			case 58: HookManager.addHook(hHOOK_SERVER_PING.INSTANCE, 					function); break;
			case 59: HookManager.addHook(hHOOK_SPAWNED_ENTITY.INSTANCE, 				function); break;
			case 60: HookManager.addHook(hHOOK_SPAWNED_MONSTER.INSTANCE, 				function); break;
			case 61: HookManager.addHook(hHOOK_SPAWNING_ENTITY.INSTANCE, 				function); break;
			case 62: HookManager.addHook(hHOOK_SPAWNING_MONSTER.INSTANCE, 				function); break;
			case 63: HookManager.addHook(hHOOK_TAKE_DAMAGE.INSTANCE, 					function); break;
			case 64: HookManager.addHook(hHOOK_TICK.INSTANCE, 							function); break;
			case 65: HookManager.addHook(hHOOK_UPDATED_SIGN.INSTANCE, 					function); break;
			case 66: HookManager.addHook(hHOOK_UPDATING_SIGN.INSTANCE, 					function); break;
			case 67: HookManager.addHook(hHOOK_WEATHER_CHANGED.INSTANCE, 				function); break;
			case 68: HookManager.addHook(hHOOK_WEATHER_CHANGING.INSTANCE, 				function); break;
			case 69: HookManager.addHook(hHOOK_WORLD_STARTED.INSTANCE, 					function); break;
			case 70: HookManager.addHook(hHOOK_WORLD_TICK.INSTANCE, 					function); break;
		}
	}
