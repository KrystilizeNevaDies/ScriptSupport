...
public class cWorld {
	...
	class BroadcastBlockAction extends VarArgFunction {
		...
		public LuaValue call(LuaValue[] args, Varargs varargs) {
			BlockPosition position = new BlockPosition(args[1].get("x").toint(), args[1].get("y").toint(), args[1].get("z").toint());
		...
		public LuaValue call(LuaValue[] args) {
			instance.getPlayers().forEach((player) -> {
				player.sendPacketToViewersAndSelf(
					...
					Particle.valueOf(args[0].tojstring()),
					args[1].get("x").tofloat(),
					args[1].get("y").tofloat(),
					args[1].get("z").tofloat(),
					args[2].get("x").tofloat(),
					args[2].get("y").tofloat(),
					args[2].get("z").tofloat(),
					1)
				);
			});
			return NIL;
	...
	class BroadcastSoundEffect extends VarArgFunction {
		 ...
		 * Pitch	number
		 * ExcludeClient	cClientHandle
		 * Sends the specified sound effect to all players in this world, except the optional ExceptClient
		 */
		public LuaValue call(LuaValue[] args) {
			instance.getPlayers().forEach((player) -> {
				player.playSound(
					Sound.valueOf(args[0].tojstring()), 
	...
	class CastThunderbolt extends TwoArgFunction {
		 ...
		 * 
		 * Position Vector3i
		 * Creates a thunderbolt at the specified coords
		 */
		public LuaValue call(LuaValue world, LuaValue coords) {
            ...
            spawnEntityPacket.position = new Position(coords.get("x").toint(), coords.get("y").toint(), coords.get("z").toint());
	...
	class ChunkStay extends OneArgFunction {
		 ...
		 * OnChunkAvailable	function
		 * OnAllChunksAvailable	function
	...
	class DigBlock extends ThreeArgFunction {
		...
		public LuaValue call(LuaValue world, LuaValue vector, LuaValue entity) {
			try {
				instance.setBlock(Vector3i.toBlockPosition(vector), Block.AIR);
				return TRUE;
			} catch (Exception e) {
				return FALSE;
			}
	...
	class DoWithBeaconAt extends OneArgFunction {
		 ...
		 * function Callback(BeaconEntity)The function returns false if there is no beacon, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithBedAt extends OneArgFunction {
		 ...
		 * function Callback(cBedEntity)The function returns false if there is no bed, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithBlockEntityAt extends OneArgFunction {
		 ...
		 * function Callback(BlockEntity)The function returns false if there is no block entity, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithBrewingstandAt extends OneArgFunction {
		 ...
		 * function Callback(cBrewingstandEntity)The function returns false if there is no brewingstand, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithChestAt extends OneArgFunction {
		 ...
		 * function Callback(ChestEntity)The function returns false if there is no chest, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithCommandBlockAt extends OneArgFunction {
		 ...
		 * function Callback(CommandBlockEntity)The function returns false if there is no command block, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithDispenserAt extends OneArgFunction {
		 ...
		 * function Callback(DispenserEntity)The function returns false if there is no dispenser, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithDropSpenserAt extends OneArgFunction {
		 ...
		 * function Callback(DropSpenserEntity)Note that this can be used to access both dispensers and droppers in a similar way. The function returns false if there is neither dispenser nor dropper, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithDropperAt extends OneArgFunction {
		 ...
		 * function Callback(DropperEntity)The function returns false if there is no dropper, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithEntityByID extends OneArgFunction {
		 ...
		 * function Callback(Entity)The function returns false if the entity was not found, and it returns the same bool value that the callback has returned if the entity was found.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithFlowerPotAt extends OneArgFunction {
		 ...
		 * function Callback(FlowerPotEntity)The function returns false if there is no flower pot, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithFurnaceAt extends OneArgFunction {
		 ...
		 * function Callback(FurnaceEntity)The function returns false if there is no furnace, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithHopperAt extends OneArgFunction {
		 ...
		 * function Callback(cHopperEntity)The function returns false if there is no hopper, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithMobHeadAt extends OneArgFunction {
		 ...
		 * function Callback(MobHeadEntity)The function returns false if there is no mob head, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithNearestPlayer extends OneArgFunction {
		 ...
		 * function Callback(Player)The function returns false if the player was not found, or whatever bool value the callback returned if the player was found.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DoWithNoteBlockAt extends OneArgFunction {
		 ...
		 * function Callback(NoteEntity)The function returns false if there is no note block, or if there is, it returns the bool value that the callback has returned.
		 */
		public LuaValue call(LuaValue world) {
	...
	class DropBlockAsPickups extends VarArgFunction {
		 ...
		 */
		public LuaValue call(LuaValue[] args) {
			instance.breakBlock(null, Vector3i.toBlockPosition(args[1]));
			return NIL;
		}
	}
	class FastSetBlock extends VarArgFunction {
		 ...
		 */
		public LuaValue call(LuaValue[] args) {
			instance.setBlock(Vector3i.toBlockPosition(args[1]), Block.values()[args[2].toint()]);
			return NIL;
		}
	}
	...
	class ForEachBlockEntityInChunk extends OneArgFunction {
		 ...
		 * function Callback(BlockEntity)The callback should return false or no value to continue with the next block entity, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachBrewingstandInChunk extends OneArgFunction {
		 ...
		 * function Callback(cBrewingstandEntity)The callback should return false or no value to continue with the next brewingstand, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachChestInChunk extends OneArgFunction {
		 ...
		 * function Callback(ChestEntity)The callback should return false or no value to continue with the next chest, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachEntity extends OneArgFunction {
		 ...
		 * function Callback(Entity)The callback should return false or no value to continue with the next entity, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachFurnaceInChunk extends OneArgFunction {
		 ...
		 * function Callback(FurnaceEntity)The callback should return false or no value to continue with the next furnace, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachLoadedChunk extends OneArgFunction {
		 ...
		 * function Callback(ChunkX, ChunkZ)The callback should return false or no value to continue with the next chunk, or true to abort the enumeration.
		 */
		public LuaValue call(LuaValue world) {
	...
	class ForEachPlayer extends TwoArgFunction {
		 ...
		 * function Callback(Player)The callback should return false or no value to continue with the next player, or true to abort the enumeration.
		 */
	...
	class GetBiomeAt extends ThreeArgFunction {
		 ...
		 */
		public LuaValue call(LuaValue world, LuaValue x, LuaValue z) {
			Biome biome = instance.getChunkAt(new BlockPosition(x.toint(), 0, z.toint())).getBiomes()[(x.toint() % 16) + ((z.toint() % 16) % 4)];
	...
	class GetBlock extends TwoArgFunction {
		...
		public LuaValue call(LuaValue world, LuaValue vector) {
			return valueOf(Block.fromStateId(instance.getBlockStateId(Vector3i.toBlockPosition(vector))).ordinal());
		}
	}
	...
	class GetBlockInfo extends VarArgFunction {
		...
		public Varargs call(LuaValue[] args) {
			BlockPosition position = Vector3i.toBlockPosition(args[1]);
			LuaValue[] returnValue = {
				valueOf(Block.fromStateId(instance.getBlockStateId(position)) != Block.AIR),
	...
	class GrowRipePlant extends OneArgFunction {
		 ...
		 * BlockPosition	Vector3i
		 * boolean
		 * Grows the plant at the specified coords to its full. Returns true if the plant was grown, false if not.
		 */
		public LuaValue call(LuaValue world) {
	...
	class WakeUpSimulatorsInArea extends OneArgFunction {
		 ...
		 * 
		 * 
		 * MinPosition Vector3i
		 * MaxPosition Vector3i
		 * Wakes up the simulators for all the blocks in the specified area (edges inclusive). (DEPRECATED, use vector-parametered version)
		 */
		public LuaValue call(LuaValue world) {
